...
interface Props
  extends StackScreenProps<RootStackParamsInformaticoDos, 'Pendiente'> {}

const { width, height } = Dimensions.get('window');

const PendienteScreen = ({navigation}:Props) => {
  ...
  const mostrarAlerta = async () => {
      try {
          ...
          const resp = await alertaPerfilApi.get<ResultAlertasDerivadas>('/alertaderivada/alerta/informatico',{params:{estado:3}});
                              ...
                              <View style={style.containerCuadro}>
                                  ...
                                  <View style={{ width: '70%', marginBottom: 10 }}>
                                      ...
                                      >
                                          <TouchableOpacity
                                              style={style.boton}
                                              onPress={() => navigation.navigate('AlertaPendiente', { id_alerta: resp.id })}
                                          >
                                              <Text style={{
                                                  color: 'white',
                                                  fontWeight: '700'
...
export default PendienteScreen;
